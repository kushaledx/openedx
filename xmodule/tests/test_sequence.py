...
class SequenceBlockTestCase(XModuleXmlImportTest):
    ...
    @patch("openedx.core.lib.gating.api.get_required_content")
    def test_export_sequence_invalid_min_score_prerequisites(self, mock_get_required_content):
        """
        Test that add_prerequisite_to_xml adds No prerequisite information if
        min_score or min_completion has incorrect values
        """
        xml_object = etree.Element('sequential')
    ...
    @patch("openedx.core.lib.gating.api.get_required_content")
    def test_export_sequence_invalid_min_completion_prerequisites(self, mock_get_required_content):
        """
        Test that add_prerequisite_to_xml adds No prerequisite information if
        min_score or min_completion has incorrect values
        """
    ...
    @patch("openedx.core.lib.gating.api.get_required_content")
    def test_export_sequence_missing_required_content_prerequisites(self, mock_get_required_content):
        """
        Test that add_prerequisite_to_xml adds No prerequisite information if
        min_score or min_completion has incorrect values
        """
